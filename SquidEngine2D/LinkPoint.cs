    ...
    public class LinkPoint
    {
        ...
        public Vector2 Position
        {
            get
            {
                ...
                Vector2 _worldPos=SquidVectorUtil.VectorToWorldSpace
                                    (
                                    offset, 
                                    SquidVectorUtil.ConvertToCartesianCoordinates(1, Owner.Rotation)
                                    );
        ...
        public void Update()
        {
                ...
                && (_calculateOwnerInducedRotationOffset == true || _lastOwnerRotation != Owner.Rotation))
            {
                ...
                _ownerInducedRotationOffset.X = _offsetVectorLenght * SquidMath.CosFromRadians(angle);
                _ownerInducedRotationOffset.Y = _offsetVectorLenght * SquidMath.SinFromRadians(angle);
