...
{
    public class SceneItem : SquidBase
    {
        #region Fields
        ...
        private List<SquidComponent> _components = new List<SquidComponent>();
        private SquidScene _sceneParent = null; // null if global for now        
        ...
        #if WINDOWS
        [TypeConverter(typeof(SquidEngine.SceneItems.TypeConverters.LayerConverter))]
        #endif
        ...
        [BrowsableAttribute(false)]
        public List<SquidComponent> Components
        {
        ...
        /// <returns></returns>
        public T GetComponent<T>() where T : SquidComponent
        {
            T local = default(T);
            foreach (SquidComponent component in Components)
            {
        ...
        internal virtual void OnRegister()
        {
            SetupLinkFuses();
            UpdateBoundingRect();
            foreach (SquidComponent _component in Components)
            {
        ...
        public void AddComponent(SquidEngine.Components.SquidComponent component)
        {
