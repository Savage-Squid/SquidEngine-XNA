...
namespace SquidEngine.SceneItems
{
    public class PostProcessAnimation : SceneItem, IAnimation
    {
        ...
        #if !XNATOUCH
		private SquidEffect _iceEffect;
        private SquidEffectParameters _iceEffectParameters;
        ...
        public int Life
        {
            ...
            set
            {
                _life = value;
                _maxLife = value * 60;
                _currentLife = SquidMath.Clamp(_currentLife, 0, _maxLife);
            }
        }
        ...
        public override void CopyValuesTo(SceneItem target)
        {
			...
			#if !XNATOUCH
            ppAnim.SquidEffect = this.SquidEffect;
#endif
