...
namespace SquidEngine.SceneItems.ParticlesClasses
{  
        ...
        public Vector2 GetNewEmissionPoint()
        {
            ...
            switch (type)
            {
                ...
                case EmitterShapeType.Circle:
                    ...
                    emissionPointOffset.X = radius.X * SquidMath.CosFromRadians(angle);
                    emissionPointOffset.Y = radius.Y * SquidMath.SinFromRadians(angle); 
                    break;
                case EmitterShapeType.CircleOutline:
                    float angle2 = Randomizer.AngleInRadians();
                    emissionPointOffset.X = size.X * SquidMath.CosFromRadians(angle2);
                    emissionPointOffset.Y = size.Y * SquidMath.SinFromRadians(angle2);
                    break;
