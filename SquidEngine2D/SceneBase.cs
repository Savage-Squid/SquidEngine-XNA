...
namespace SquidEngine
{
    public class SceneBase
    {
        ...
        private List<SquidSceneComponent> _sceneComponents = new List<SquidSceneComponent>();
        ...
        private List<SquidFont> _fonts = new List<SquidFont>();
        #if !XNATOUCH
		private List<SquidEffect> _effects = new List<SquidEffect>();
#endif
        ...
        public List<SquidSceneComponent> SceneComponents
        {
        ...
        public List<SquidFont> Fonts
        {
            get { return _fonts; }
            set { _fonts = value; }
        }
		#if !XNATOUCH
        public List<SquidEffect> Effects
        {
            get { return _effects; }
            set { _effects = value; }
        }
        ...
        public virtual SquidFont GetFont(string name)
        {
            foreach (SquidFont _font in _fonts)
            {
                if (_font.Name == name)
                {
                    return _font;
