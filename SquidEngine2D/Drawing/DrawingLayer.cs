    ...
    public class DrawingLayer
    {
        ...
        {               
            ...
            if (_postProcessRequestCollection.Count > 0)
            {
                ...
                {
                    _postProcessRequestCollection[i].SquidEffect.
                        SetParameters(_postProcessRequestCollection[i].SquidEffectParameters);
                    _postProcessRequestCollection[i].SquidEffect.Draw(DrawingManager.SpriteBatch);         
                }
