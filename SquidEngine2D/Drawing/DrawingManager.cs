...
namespace SquidEngine.Drawing
{
    public static class DrawingManager
    {
		...
		private static SquidEffect[] _embeddedSquidEffects;
...
#if !XNATOUCH
        public static SquidEffect[] EmbeddedSquidEffects
        {
            get { return _embeddedSquidEffects; }
        }
...
#endif
            LoadEmbeddedSquidEffects();            
        }

        private static void LoadEmbeddedSquidEffects()
        {
#if !XNATOUCH
            _embeddedSquidEffects[(int)EmbeddedSquidEffectType.None]
                = new NoEffect();
            _embeddedSquidEffects[(int)EmbeddedSquidEffectType.Bloom]
                = new BloomEffect();
            _embeddedSquidEffects[(int)EmbeddedSquidEffectType.GaussianBlur]
