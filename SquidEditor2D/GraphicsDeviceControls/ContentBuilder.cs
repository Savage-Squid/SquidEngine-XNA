...
namespace SquidEditor.GraphicsDeviceControls
{
    ...
    class ContentBuilder : IDisposable
    {
        ...
        void logger_EventRaised(string obj)
        {
            if (EventRaised != null)
                EventRaised(obj);
        }
        ...
        public class MyCustomBuildLogger : ILogger
        {
            ...
            public void Initialize(IEventSource eventSource)
            {
                ...
                //eventSource.ErrorRaised += new BuildErrorEventHandler(Events_ErrorRaised);
                ...
                //eventSource.MessageRaised += new BuildMessageEventHandler(Events_MessageRaised);
            }
