    ...
    {        
        ...
        public Vector2 RealMousePos
        {
            ...
            set
            {
                ...
                if (SquidEditorForm.Instance != null)
                {
                    SquidEditorForm.Instance.RefreshStatusStrip();
                }
            }
        }
        ...
        public SquidScene CurrentScene
        {
        ...
        protected override void Initialize()
        {
            ...
            SquidEngine.Drawing.DrawingManager.Initialize();
        ...
        private void Update(float elapsedTime)
        {
            if (CurrentScene != null)
            {
                ...
                {
                    SquidEditorForm.Instance.UpdatePropertyGrid();
        ...
        {
            TreeNode node = SquidEditorForm.Instance.treeViewResources.SelectedNode;
            if (node == null || node.Tag == null || (node.Tag is SceneItem) == false)
            {
                SquidEditorForm.ShowErrorMessage("You must select a Template first");
            }
            else
            {
                ...
                {
                    SquidEditorForm.ShowErrorMessage("The selected SceneItem is not a Template");
                }
                else
                {
                    SceneItem copy = SquidEditorForm.Instance.CreateNewInstaceCopyOf(template);                    
                    SquidEditorForm.Instance.AddNewSceneItemInstance(copy, SceneItemGroup.SceneInstances, false);
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (SquidEditorForm.Instance.SceneEditorTool == SquidEditorSceneEditorTool.TemplateBrush)
            {
                PasteTemplate();
            }
            base.OnMouseUp(e);
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                if (SquidEditorForm.Instance.SceneEditorTool == SquidEditorSceneEditorTool.Select)
                {
                    ...
                    if (_highlightedItem != null)
                    {
                        ...
                        if (!_selectedItems.Contains(_highlightedItem))
                        {
                                ...
                                && (Control.ModifierKeys & Keys.Shift) != Keys.Shift)
                            {
                                ...
                                SquidEditorForm.Instance.SelectItem(_highlightedItem);
                            }
                            // Multiple selection
                            else
                            {
                    ...
                    {
                        SquidEditorForm.Instance.UnselectItems();
                        _isDraggingItem = false;
                    }
                }
            }
        ...
        protected override void OnMouseDoubleClick(MouseEventArgs e)
        {
            if (SquidEditorForm.Instance.SceneEditorTool == SquidEditorSceneEditorTool.Select)
            {
                ...
                {
                    SquidEditorForm.Instance.EditSceneItem(_highlightedItem);
                }
            }
        ...
        {
            base.OnKeyDown(e);            
            SquidEditorForm.Instance.HandleKeyPress(e);
        }       
