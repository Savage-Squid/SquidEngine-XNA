...
namespace SquidEditor.GraphicsDeviceControls
{
    ...
    class MaterialDisplayControl : GraphicsDeviceControl
    {
        ...
        {            
            ...
            if (_materialType == typeof(Texture2D))
            {
            ...
            else if (_materialType == typeof(SquidFont))
            {
                _spriteBatch.Begin();
                _spriteBatch.DrawString(_font.Font, "Test String", Vector2.Zero, Color.Black);
                _spriteBatch.End();
            }
        }
    }
