...
namespace SquidEditor.Editors.TileGrids
{
    ...
    public partial class TileSelectionControl : GraphicsDeviceControl
    {
        ...
        protected override void Initialize()
        {
            ...
            this.VScroll = true;
            this.HScroll = true;
            TileGridEditor.Instance.SelectedBrushTiles.Clear();
            _highlightedTile = -1;
        ...
        protected void DrawTiles()
        {
            ...
            if (TileGridEditor.Instance.SelectedBrushTiles.Count > 0)
            {
                foreach (int tile in TileGridEditor.Instance.SelectedBrushTiles)
                {

                    Point pos = GetPosOfTile(tile);
                    int halfPadding = _padding / 2;
                    pos.X -= halfPadding - this.AutoScrollPosition.X;
                    pos.Y -= halfPadding - this.AutoScrollPosition.Y;
                    DrawingManager.DrawFilledRectangle(ParentGrid.Layer, new Vector2(pos.X, pos.Y),
