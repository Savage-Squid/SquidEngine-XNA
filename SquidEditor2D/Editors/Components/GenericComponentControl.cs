...
namespace SquidEditor.Editors.Components
{
    public partial class GenericComponentControl : ScrollableControl
    {
        ...
        private SquidComponent _component = null;
        ...
        internal SquidComponent SelectedComponent
        {
        ...
        {        
            ...
            else if (_info.PropertyType == typeof(SquidEngine.Drawing.SquidColor))
            {
                return new AutoControlColor();
            }
