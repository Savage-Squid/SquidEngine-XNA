...
{
    public class SquidEngineProject
    {
        #region Static Methods
        public static SquidEngineProject Instance;
        ...
        [XmlIgnore]
        public Dictionary<Type,Assembly> SquidSceneComponents { get; set; }
        [XmlIgnore]
        public Dictionary<Type, Assembly> SquidSceneItemComponents { get; set; }
        ...
        private void SaveToFile(string filename)
        {
            ...
            XmlSerializer _serializer = new XmlSerializer(typeof(SquidEngineProject));
